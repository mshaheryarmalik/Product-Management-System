...
namespace PMS.DAL
{
    public static class ProductDAO
    {
        ...
        {
            var query = "select p.*, u.Name from dbo.Products p INNER JOIN dbo.Users u ON (p.CreatedBy=u.UserID) WHERE p.IsActive=1;";
        ...
        private static ProductDTO MyFillDTO(SqlDataReader reader)
        {
            var dto = new ProductDTO();
            dto.ProductID = reader.GetInt32(0);
            dto.Name = reader.GetString(1);
            ...
            dto.IsActive = reader.GetBoolean(8);
            dto.Username = reader.GetString(9);
            return dto;
        }
    }
}
